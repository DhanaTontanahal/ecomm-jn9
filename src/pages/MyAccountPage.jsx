...
export default function MyAccountPage({ onBack, onHelp }) {
    ...
    const openExternal = (url, fallbackMsg) => {
    ...
    // 🔹 NEW: fetch Android / iOS app links once
    useEffect(() => {
        (async () => {
            try {
                ...
                <Card>
                    ...
                    <Row
                        onClick={() =>
                            openExternal(
                                appLinks.androidUrl,
                                "Android app link will be available soon."
                            )
                        }
                    >
                        <LeadingIcon>
                    ...
                    <Row
                        onClick={() =>
                            openExternal(
                                appLinks.iosUrl,
                                "iOS app link will be available soon."
                            )
                        }
                    >
                        <LeadingIcon>
