    ...
    <Wrapper>
      <Container>
        ...
        >
          ...
          <ComparisonGrid>
            <ComparisonCard>
              <div className="head">
                ...
                <span className="tag">Use the software</span>
              </div>
              <p>
                Your monthly plan is for accessing and using Orgo Health
                Commerce as a service.
              </p>
              <ul>
                <li>Access to web app, admin, POS and dashboards</li>
                <li>Feature updates and improvements over time</li>
                <li>Cloud hosting and security for your data</li>
                <li>Ongoing product support within your plan limits</li>
              </ul>
            </ComparisonCard>
            ...
            <ComparisonCard>
              <div className="head">
                ...
                <h4>One-Time Implementation &amp; AMC</h4>
                <span className="tag">Set up + support</span>
              </div>
              <p>
                The one-time fee covers building and launching your branded
                system, and AMC covers long-term care.
              </p>
              <ul>
                <li>Branding, domain, SSL and infrastructure setup</li>
                <li>Android &amp; iOS app builds and store deployment</li>
                <li>Workflow configuration, integrations &amp; onboarding</li>
                <li>Annual Maintenance (AMC) for updates &amp; priority fixes</li>
              </ul>
            </ComparisonCard>
          </ComparisonGrid>
          ...
          <SmallNote>
            <h4>
              <FiInfo /> How implementation &amp; AMC pricing works
            </h4>
            ...
            <strong>₹2,50,000 – ₹4,00,000</strong>, depending on scope and custom
            workflows.
            <br />
            <br />
          ...
          <FAQSection>
            <FAQTitle>
              <FiHelpCircle /> Pricing FAQ
            </FAQTitle>
            <FAQList>
              <FAQItem>
                <FAQQuestion>
                  Do I have to pay the one-time fee if I’m on a monthly plan?
                </FAQQuestion>
                <FAQAnswer>
                  Yes. The monthly plan covers your <strong>software usage</strong> (SaaS),
                  while the one-time fee covers all the <strong>initial setup work</strong>:
                  branding, domain &amp; hosting configuration, app builds, store
                  deployment and workflow setup. It’s a one-time project cost, not a
                  subscription.
                </FAQAnswer>
              </FAQItem>

              <FAQItem>
                <FAQQuestion>What happens after the first year of AMC?</FAQQuestion>
                <FAQAnswer>
                  After the first year, you can renew AMC annually (usually{" "}
                  <strong>10–15% of the original implementation cost</strong>) to
                  continue receiving upgrades, monitoring, bug fixes and priority
                  support. If you don’t renew, you still keep access to the system as
                  long as your subscription is active, but support is limited.
                </FAQAnswer>
              </FAQItem>
              ...
              <FAQItem>
                ...
                <FAQAnswer>
                  Yes. Many businesses start with <strong>Starter</strong> or{" "}
                  <strong>Growth</strong>, and upgrade to <strong>Pro / Enterprise</strong>{" "}
                  once they scale. When you upgrade, your monthly fee changes, but the
                  previous implementation work is reused wherever possible.
                </FAQAnswer>
              </FAQItem>

              <FAQItem>
                <FAQQuestion>
                  Do you deploy to our own Firebase / cloud account?
                </FAQQuestion>
                <FAQAnswer>
                  Yes. For Pro / Enterprise projects, we can deploy to your own
                  Firebase / cloud account for full ownership and transparency. This is
                  usually part of the <strong>implementation scope</strong> and may
                  impact the one-time fee.
                </FAQAnswer>
              </FAQItem>
