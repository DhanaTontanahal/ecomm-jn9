    ...
    <Wrapper>
      <Container>
        ...
        >
          ...
          <SmallNote>
            One-time implementation (web app, admin portal, Android &amp; iOS
            apps, hosting and domain mapping, Play Store deployment) typically
            starts from <strong>₹1,80,000</strong>, depending on customisation.
            Ongoing AMC / support plans are also available.
          </SmallNote>
        </PricingSection>
      </Container>
    </Wrapper>
