...
const Bar = styled.div`
  ...
  /* key: allow middle column to shrink properly */
...
const Nav = styled.nav`
  ...
  display: flex;
  align-items: center;
  justify-content: flex-start;  /* avoid centering overflow into Right */
...
const NavList = styled.ul`
  ...
  /* key: keep inside middle column and scroll when needed */
  max-width: 100%;
  min-width: 0;
  overflow-x: auto;
  overflow-y: hidden;
