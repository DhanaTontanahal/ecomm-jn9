...
const SocialIcon = styled.a`
  ...
  &:hover {
    ...
    background: ${({ type }) => (type === "youtube" ? "#ff0000" : "#e1306c")};
...
const DEFAULT_INSTAGRAM = "https://www.instagram.com/prakrutifarmsbharat/";
const DEFAULT_YOUTUBE = "https://www.youtube.com/@prakrutiFarmsBH";
...
export default function SiteFooter({ policyLinks = [] }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.error("Error loading social links for footer", e);
  ...
  const { instagramUrl, youtubeUrl } = social;
  ...
  return (
    <Footer>
      <FooterGrid>
        ...
        <div>
          ...
          <p style={{ fontSize: 14, lineHeight: "1.6" }}>
            Fresh. Organic. Ethical. Delivered directly from our farms to your
            home.
          </p>

          {/* ✅ Social Icons (from Firestore, with fallback) */}
          <SocialRow>
            <SocialIcon
              href={instagramUrl}
              target="_blank"
      ...
      <BottomBar>
        © {new Date().getFullYear()} Prakruti Farms Bharat. All rights
        reserved.
      </BottomBar>
    </Footer>
  );
